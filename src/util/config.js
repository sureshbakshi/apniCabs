...
export default {
  ...
  STORE_ANDROID_DRIVER_URL: Config.STORE_ANDROID_DRIVER_URL,
  STORE_ANDROID_USER_URL: Config.STORE_ANDROID_USER_URL,
  STORE_IOS_DRIVER_URL: Config.STORE_IOS_DRIVER_URL,
  STORE_IOS_USER_URL: Config.STORE_IOS_USER_URL
}
